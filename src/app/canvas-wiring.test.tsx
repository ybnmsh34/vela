...
describe('an artifact in an answer reaches the panel', () => {
   ...
   * **ten-odd** submits for one artifact — the count tracks how many batches the
   * stream drains in, so it moves with the machine.
   *
   ...
   * three is all that is left of a defect worth ten-odd submits — which
   ...
   * drop this guard from catching ten-odd to catching three.
   */
