...
function ToolCallCard({ view }: { readonly view: ToolCallView }) {
  ...
  // Open by default while it moves, and when it went wrong — a refusal nobody
  // expands is a refusal nobody reads. Settled and fine collapses to one line.
  const open = choice ?? (live || refused);
