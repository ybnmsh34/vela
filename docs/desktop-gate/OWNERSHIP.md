...
| `src/platform/verify-covers-ci.test.ts` | Wave 1 / caps | 2026-08-15 | same defect shape one directory over: the CI guard reads `.github/workflows/ci.yml` by name out of a directory GitHub Actions runs whole |
