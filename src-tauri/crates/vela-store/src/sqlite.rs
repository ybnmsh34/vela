...
use crate::model::{
    validate_memory_content, Cadence, ContentPart, Conversation, ConversationId, ConversationPatch,
...
use crate::repository::{
    ...
    SearchHitKind, SettingsRepository, UsageTotals,
};
...
mod tests {
    ...
    /// The cascade `0004_memory.sql` argues for: an entry whose project is gone
